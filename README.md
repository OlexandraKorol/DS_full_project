...
4. перетворює дати. (Конвертація дат застосовується лише за наявності datetime-колонок, у обраному датасеті не застосовується)
...
Також реалізовано логарифмічне перетворення числових даних за допомогою:
...
що допомагає зробити великі значення менш різкими та покращити роботу моделі.
...
Оскільки масштабування є важливим для моделей, що працюють із відстанями або у лінійному просторі.
...
Naive Bayes: 0.734
Logistic: 0.764
{'best_model_name': 'Logistic', 'best_model': Pipeline(steps=[('scaler', StandardScaler()), ('model', LogisticRegression())]), 'f1_score': 0.7639560577003253}
```
# Тестування
...
## Чистота та читабильність коду

Код перевірено за допомогою бібліотеки flake8. Виявлені стилістичні помилки відсутні або мінімізовані, що покращує читабельність і підтримуваність коду.
Також сворено  файл конфігурації .flake8 у корені проєкту.

Для запуску перевірки використовується команда:
